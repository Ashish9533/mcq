...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">{{ $activities->total() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Login Activities</dt>
                                <dd class="text-lg font-semibold text-gray-900">{{ $activities->where('action', 'login')->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Exam Activities</dt>
                                <dd class="text-lg font-semibold text-gray-900">{{ $activities->whereIn('action', ['exam_started', 'exam_submitted'])->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">{{ $activities->where('created_at', '>=', now()->startOfDay())->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <x-activity-log.activity-log-table :activities="$activities" />
        </div>

        <!-- Filter Modal -->
        <x-activity-log.activity-filter-modal :actions="$actions" />
    </div>
</div>
@endsection 